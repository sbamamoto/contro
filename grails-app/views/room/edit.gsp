                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="devices"><g:message code="room.devices.label" default="Devices" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: roomInstance, field: 'devices', 'errors')}">
                                    <g:select name="devices" from="${contro.Device.list()}" multiple="yes" optionKey="id" size="5" value="${roomInstance?.devices*.id}" />
                                </td>
                            </tr>
