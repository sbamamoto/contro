                                ...
                                <div class="panel-body">
                                    <table class="tables">
                                        <g:each var="device" in='${room.devices.sort{it.description}}'>
                                            <tr>
                                                <td style="padding-top:15px;padding-right:3px;"><button id="${device.device}-ON" type="button" class="btn btn-lg ${device.state=='ON' ? 'btn-default' : 'btn-primary'}" onclick="switchDevice('${device.device}', '150')"><h1>ON</h1></button></td>
                                                <td style="padding-top:15px;padding-right:15px;"><button id="${device.device}-OFF" type="button" class="btn btn-lg ${device.state=='OFF' ? 'btn-default' : 'btn-primary'}" onclick="switchDevice('${device.device}', '0')"><h1>OFF</h1></button></td>
