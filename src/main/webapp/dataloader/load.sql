...
insert into processor (id,version,name,description,type,processing_script) values (3,0,'HomeMatic','HMTC Set Dimm','SCRIPT','fqaddr = address+channel
command = "LEVEL"
...
insert into ability (id,version,name,description,type,read_only, processor_id) values (2,0,'Homematic Thermostat','Homematic Bridge Thermostat Control','DIRECT',false, 2);
insert into ability (id,version,name,description,type,read_only, processor_id) values (3,0,'Homematic Dimmer','Homematic Bridge Dimmer Control','DIRECT',false, 2);

insert into device_type (id,version,name,description) values (0,0,'Thermostat (HMTC)','Homematic IP Thermostat');
...
insert into device_type (id,version,name,description) values (3,0,'Dimmer (HMTC)','ArduWifi Schalter mit Kanalwahl');
