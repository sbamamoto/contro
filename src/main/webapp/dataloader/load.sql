...
insert into interface (id,version,url,description,type) values (0,0,'http://<xyour gateway address>/','ArduControl Gateway','433');
insert into interface (id,version,url,description,type) values (1,0,'http://<xyour gateway address>/','Homematic Bridge URL','HOMEMATIC');
